    ...
    <section class="py-5 bg-body border-bottom">
        <div class="container py-lg-4">
            <div class="row align-items-center g-4">
                <div class="col-lg-7">
                    <p class="text-primary-emphasis small fw-semibold mb-2"><i class="bi bi-stars me-1"></i> Регистрация и умни препоръки</p>
                    <h1 class="display-6 fw-bold mb-3">Резервации с изкуствен интелект за салони, студия и услуги на място</h1>
                    <p class="lead text-body-secondary mb-4">
                        Регистрирайте се, управлявайте бизнеси, локации, услуги и календар. Получавайте AI препоръки за часове, прогноза на натовареност и помощ при пренасочване — при конфигуриран OpenAI ключ в средата.
                    </p>
